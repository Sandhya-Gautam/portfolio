...
import { hasProtocol, isScriptProtocol, joinURL, withQuery, withBase } from 'file:///Users/sandhyagautam/Desktop/portfolio/node_modules/.pnpm/ufo@1.6.1/node_modules/ufo/dist/index.mjs';
...
import { getContext, executeAsync } from 'file:///Users/sandhyagautam/Desktop/portfolio/node_modules/.pnpm/unctx@2.4.1/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file:///Users/sandhyagautam/Desktop/portfolio/node_modules/.pnpm/h3@1.15.4/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/sandhyagautam/Desktop/portfolio/node_modules/.pnpm/vue-router@4.5.1_vue@3.5.19_typescript@5.9.2_/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///Users/sandhyagautam/Desktop/portfolio/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { defu } from 'file:///Users/sandhyagautam/Desktop/portfolio/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///Users/sandhyagautam/Desktop/portfolio/node_modules/.pnpm/vue@3.5.19_typescript@5.9.2/node_modules/vue/server-renderer/index.mjs';
...
const mr = Symbol.toStringTag, wi = n$1((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n$1((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Ks = n$1((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Js = n$1((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a } = await import('./multipart-parser-CeSwhlgh.mjs');
...
const unhead_sTWps3SJP7gwRC1zanrTPqrcwAd6sKQjB9kM17U8_U8 = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-Bic9s-xD.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-eY9cqS4b.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-DTKY5Paa.mjs')
  },
  {
    name: "projects",
    path: "/projects",
    component: () => import('./projects-i2cEvl5Y.mjs')
  }
];
...
const revive_payload_server_ymXNkOttGL5GZW3XVbH5xwyFXRBHAFAeMnK5Yo_Hg8k = /* @__PURE__ */ defineNuxtPlugin({
...
let routes;
const prerender_server_am5N1wbjC61tu7EJHmEUcUB3SIIPKfHVPtd56JxqmrQ = /* @__PURE__ */ defineNuxtPlugin(async () => {
  let __temp, __restore;
...
const plugins = [
  unhead_sTWps3SJP7gwRC1zanrTPqrcwAd6sKQjB9kM17U8_U8,
  plugin,
  revive_payload_server_ymXNkOttGL5GZW3XVbH5xwyFXRBHAFAeMnK5Yo_Hg8k,
  components_plugin_z4hgvsiddfKkfXTP6M8M4zG5Cb7sGnDhcryKVM45Di4,
  prerender_server_am5N1wbjC61tu7EJHmEUcUB3SIIPKfHVPtd56JxqmrQ
];
const layouts = {
  default: defineAsyncComponent(() => import('./default-C2e-3zFt.mjs').then((m) => m.default || m))
};
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.19.2_@netlify+blobs@9.1.2_@parcel+watcher@2.5.1_@types+node@24.3.0_@vue+compiler_8f616af5606fc7e1bb15164a6dd79bfc/node_modules/nuxt/dist/pages/runtime/app.vue");
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BWw8i3nH.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-RXtmRQC6.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.19.2_@netlify+blobs@9.1.2_@parcel+watcher@2.5.1_@types+node@24.3.0_@vue+compiler_8f616af5606fc7e1bb15164a6dd79bfc/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.19.2_@netlify+blobs@9.1.2_@parcel+watcher@2.5.1_@types+node@24.3.0_@vue+compiler_8f616af5606fc7e1bb15164a6dd79bfc/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { _export_sfc as _, useRouter as a, br as b, useNuxtApp as c, useRuntimeConfig as d, entry$1 as default, nuxtLinkDefaults as e, navigateTo as n, qn as q, resolveRouteObject as r, tryUseNuxtApp as t, useRoute as u };
